...
def main():
    ...
    parser.add_argument('--model_config', default='config/gpt2_general_chinese.json', type=str, required=False,
                        help='模型参数')
    parser.add_argument('--tokenizer_path', default='cache/gpt2_general_chinese_vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_path', default='model/final_model', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default='x=', type=str, required=False, help='生成文章的开头')
