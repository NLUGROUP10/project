...
vocab_path = "/scratch/zp2053/bert_seq2seq/vocab/roberta_wwm_vocab.txt"
word2idx = load_chinese_base_vocab(vocab_path)
model_name = "roberta"
model_path = "/scratch/zp2053/bert_seq2seq/weights/roberta_wwm_pytorch_model.bin"
recent_model_path = "/scratch/zp2053/bert_seq2seq/weights/bert_math_ques_model.bin"
model_save_path = "/scratch/zp2053/bert_seq2seq/weights/bert_math_ques_model.bin"
batch_size = 16
lr = 1e-5
maxlen = 256
...
class Trainer:
    ...
    def validation(self):
        ...
        for each_data in val_data:
            equation = self.bert_model.generate(each_data[0], beam_size=3)
